...
export function GoogleSignIn() {
  return (
    <a
      href="/auth/google"
      className="flex w-full items-center justify-center gap-2.5 rounded-lg border border-chrome-300 bg-white px-4 py-2.5 text-sm font-medium text-chrome-700 transition-colors hover:bg-chrome-50"
    >
      <svg className="h-4 w-4" viewBox="0 0 48 48" aria-hidden>
        ...
        <path fill="#1976D2" d="M43.6 20.1H42V20H24v8h11.3c-.8 2.3-2.3 4.3-4.1 5.7l6.2 5.2C41.1 35.6 44 30.3 44 24c0-1.3-.1-2.6-.4-3.9z" />
      </svg>
      Sign in with Google
    </a>
  );
